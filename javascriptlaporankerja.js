function doPost(e) {
  try {
    ...
    return ContentService.createTextOutput( // kembali ke hasil JSON berhasil
      JSON.stringify({
...
function setup() {
  ...
  SCRIPT_PROP.setProperty(
    "16G6gHQsQfcM45OgHFqPsfd1TS8f2GgqTSCSD8cSkeys",
    doc.getId()
  );
}
...
function uploadFileToGoogleDrive(
  ...
  try {
    var dropbox = "Foto Laporan Kerja Mechanic";
    var folder,
